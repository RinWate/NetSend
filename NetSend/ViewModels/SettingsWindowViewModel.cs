...
public partial class SettingsWindowViewModel : ViewModelBase {
    ...
    [ObservableProperty]
    private Setting _commonBase = new("CommonBase", string.Empty, false);

    [ObservableProperty]
    private Setting _defaultFilter = new("DefaultFilter", string.Empty, false);

    [ObservableProperty]
    private Setting _ignoredBase = new("IgnoredBase", string.Empty, false);

    [ObservableProperty]
    private Setting _pseudonamesBase = new("PseudonamesBase", string.Empty, false);

    [ObservableProperty]
    private Setting _templatesBase = new("TemplatesBase", string.Empty, false);
