...
public partial class MainWindowViewModel : ViewModelBase {
	...
	[ObservableProperty] private ObservableCollection<Recipient> _filteredItems = new();
	...
	/// <summary>
	/// Выполнить фильтрацию списка получателей
	/// </summary>
	...
	private async Task AddSchedule() {
		...
		await Dialog.ShowCustomModal<AddScheduleDialog, AddScheduleDialogViewModel, bool>(
			new AddScheduleDialogViewModel(), options: options);
	}
